...
LABELS = ['background', 'hat', 'hair', 'glove', 'sunglasses', 'upperclothes', 'facemask', 'coat', 'socks', 'pants', 'torso-skin', 'scarf', 'skirt', 'face', 'left-arm', 'right-arm', 'left-leg', 'right-leg', 'left-shoe', 'right-shoe', 'bag', 'others']
...
def compute_mean_ioU(preds, scales, centers, num_classes, datadir, input_size=[473, 473], dataset='val'):
    ...
    for i, im_name in enumerate(val_id):
        gt_path = os.path.join(datadir, dataset + '_segmentations','Category_ids', im_name + '.png')
    ...
    return name_value, pixel_accuracy, mean_accuracy
